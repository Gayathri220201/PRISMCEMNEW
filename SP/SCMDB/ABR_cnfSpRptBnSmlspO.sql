...
/******************************************************************************/
/* Procedure					: ABR_cnfSpRptBnSmlspO      				  */
/* Description					: 								              */
/******************************************************************************/
/* Project						: 								              */
/* EcrNo						: 								              */
...
Create Procedure ABR_cnfSpRptBnSmlspO
...
Begin
	...
	Set @statementperiod    = ltrim(rtrim(@statementperiod))
   ...
   Select
		...
		where	guid	          =	@gu_id  
		and     display_option = 'Deductions' 
	and     display_remarks   = 'Receipts in Bank Statement but not in Bank Book'
